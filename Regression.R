#Author:Cinthia Gomez, Date:08/25/2026, Purpose:Test the regression analysis
...
#Create a training dataset with a 50% split
...
#Predict the relationshop between mpg and weight of the car on test data set using our generated regression model
prediction_result <-predict(regression_model,test_dataset)

#Results of prediction
actual_prediction_vaules<-data.frame(cbind(actuals=training_data$mpg,predicteds=prediction_result))
